...
tags: [Windows , ACL's Abuse , AD , DCSync Attack , DPAPI Dump]
toc: true
comments: true
...
![](/assets/img/attachments/puppy.png)
...
![](/assets/img/attachments/puppy-1.png)
...
lets verify:
![](/assets/img/attachments/puppy-2.png)
...
```
![](/assets/img/attachments/puppy-3.png)
We got the password!

![](/assets/img/attachments/puppy-4.png)
...
![](/assets/img/attachments/puppy-7.png)
...
![](/assets/img/attachments/puppy-8.png)
...
```
![](/assets/img/attachments/puppy-9.png)

And to verify it worked, will run rpcclient again (or Ldapsearch)
![](/assets/img/attachments/puppy-10.png)
...
```
## Priv Escalation
![](/assets/img/attachments/puppy-11.png)
...
![](/assets/img/attachments/puppy-12.png)

i downloaded this file 
![](/assets/img/attachments/puppy-13.png)
## DPAPI Dump
And found in it this user password, lets test if its valid or not
![](/assets/img/attachments/puppy-14.png)
...
![](/assets/img/attachments/puppy-15.png)
![](/assets/img/attachments/puppy-16.png)
...
![](/assets/img/attachments/puppy-17.png)
Then download
...
```
![](/assets/img/attachments/puppy-18.png)
